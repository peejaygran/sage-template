...
<script type="text/javascript" src="/assets/dist/js/journey-dry-cleaning.js?v={{ time() }}"></script>
                ...
                <form id="journey" action="./" method="post" enctype="multipart/form-data">
                    <div class="card-body p-0">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6 pt-2 pb-2 services">
                            ...
                            <div class="form-group col-sm-12 py-1 services">
                                <label>Please choose services </label>
                                <div class="input-group">
                                    <button type="button" class="btn switch-button p-2 m-2 btn-outline-primary">Small (up to 5kg)</button>
                                    <button type="button" class="btn switch-button p-2 m-2 btn-outline-primary">Large (up to 10kg)</button>
                                    <button type="button" class="btn switch-button p-2 m-2 btn-outline-primary">Single Blanket</button>
                                    <button type="button" class="btn switch-button p-2 m-2 btn-outline-primary">Double Blanket</button>
                                    <button type="button" class="btn switch-button p-2 m-2 btn-outline-primary">King Blanket</button>
                                </div>
                            </div>
                        </div>
