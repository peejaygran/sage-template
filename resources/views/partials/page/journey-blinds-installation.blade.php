...
<script type="text/javascript" src="/assets/dist/js/journey-blinds-installation.js?v={{ time() }}"></script>
<script type="text/javascript" src="/assets/dist/js/input-authentication.js?v={{ time() }}"></script>

<div class="container journey journey-blinds-installation mt-5 px-3 px-md-0">
            ...
            <div class="col-lg-8">
                ...
                <form id="journey" action="./" method="post" enctype="multipart/form-data">
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="form-group col-lg-3 pt-4 pb-2">
                                <label for="drop_windows_count">Number of windows</label>
                                <select id="drop_windows_count" class="form-control mt-1">
                                    <option>1</option>
                                    <option>2</option>
                                    <option>3</option>
                                    <option>4</option>
                            ...
                            <div class="form-group col-lg-9 pt-4 pb-2 services">
                                <label>Please choose services ( can be multiple )</label>
                                <div class="input-group">
                                    <button type="button" class="btn check-button p-2 m-1 btn-outline-primary">Blinds</button>
                                    <button type="button" class="btn check-button p-2 m-1 btn-outline-primary">Shades</button>
                                    <button type="button" class="btn check-button p-2 m-1 btn-outline-primary">Shutters</button>
                                </div>
                            </div>
