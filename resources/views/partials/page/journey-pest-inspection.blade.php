...
<script type="text/javascript" src="/assets/dist/js/journey-pest-inspection.js?v={{ time() }}"></script>
<script type="text/javascript" src="/assets/dist/js/input-authentication.js?v={{ time() }}"></script>

<div class="container journey journey-pest-inspection mt-5 px-3 px-md-0">
    <input id="wp-nonce" type="hidden" value="{{ wp_create_nonce() }}" >
    <div class="row">
        <div class="col-lg-6">
            <h3>Building Pest Inspection</h3>
            <p class="lead">To schedule your home inspection, please fill out the form below. We will welcome the opportunity to respond as soon as possible.</p>
            ...
            <form id="journey" action="./" method="post" enctype="multipart/form-data">
                <div class="card-body p-0">
                    <div class="row">
                        ...
                        <div class="form-group bedroom-count col-sm-12 mb-1">
