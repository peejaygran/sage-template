...
<div id="login-page" class="row justify-content-center">
    ...
    <div class="card col-11 col-sm-8 col-md-8 my-5">
        <div class="card-body row">
            ...
            <div class="col-md-6 d-none d-md-flex align-items-center justify-content-center">
                <svg xmlns="http://www.w3.org/2000/svg" id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1"
                    width="300" height="300" viewBox="0 0 744.84799 747.07702"
                    class="injected-svg ClassicGrid__ImageFile-sc-td9pmq-4 fNAcXv grid_media"
                    xmlns:xlink="http://www.w3.org/1999/xlink">
                    <path id="fa3b9e12-7275-481e-bee9-64fd9595a50d-8" data-name="Path 1"
                        ...
                        transform="translate(-227.576 -76.46149)" fill="#f2f2f2"></path>
                    <path id="bde08021-c30f-4979-a9d8-cb90b72b5ca2-9" data-name="Path 2"
                        ...
                        transform="translate(-227.576 -76.46149)" fill="#f2f2f2"></path>
                    <path id="b3ac2088-de9b-4f7f-bc99-0ed9705c1a9d-10" data-name="Path 22"
                        ...
                        transform="translate(-227.576 -76.46149)" fill="#e6e6e6"></path>
                    <path id="b2715b96-3117-487c-acc0-20904544b5b7-11" data-name="Path 23"
                        ...
                        transform="translate(-227.576 -76.46149)" fill="#fff"></path>
                    <path id="b06d66ec-6c84-45dd-8c27-1263a6253192-12" data-name="Path 6"
                        ...
                        transform="translate(-227.576 -76.46149)" fill="#ccc"></path>
                    <path id="e73810fe-4cf4-40cc-8c7c-ca544ce30bd4-13" data-name="Path 7"
                    ...
                    <circle id="a4813fcf-056e-4514-bb8b-e6506f49341f" data-name="Ellipse 1" cx="364.43401"
                        cy="261.50202" r="24.45" fill="#007bff"></circle>
                    <path id="bbe451c3-febc-41ba-8083-4c8307a2e73e-14" data-name="Path 8"
                    ...
                    <rect id="bb28937d-932f-4fdf-befe-f406e51091fe" data-name="Rectangle 1" x="218.56201"
                        y="447.10197" width="218.552" height="2.047" fill="#ccc"></rect>
                    <circle id="fcef55fc-4968-45b2-93bb-1a1080c85fc7" data-name="Ellipse 2" cx="225.46401"
                        cy="427.41999" r="6.902" fill="#007bff"></circle>
                    ...
                    <circle id="e8fa0310-b872-4adf-aedd-0c6eda09f3b8" data-name="Ellipse 3" cx="225.46401"
                        cy="496.43702" r="6.902" fill="#007bff"></circle>
                    <path
                        ...
                        transform="translate(-227.576 -76.46149)" fill="#007bff"></path>
                    ...
                    <circle id="aff120b1-519b-4e96-ac87-836aa55663de" data-name="Ellipse 10" cx="270.492"
                        cy="496.43702" r="6.902" fill="#007bff"></circle>
                    <path id="f1094013-1297-477a-ac57-08eac07c4bd5-15" data-name="Path 88"
                    ...
                    <path
                        ...
                        transform="translate(-303.00873 15.2906) rotate(-5.62529)" fill="#2f2e41"></path>
                    ...
                    <path id="ae7af94f-88d7-4204-9f07-e3651de85c05-16" data-name="Path 99"
                    ...
                    <path
                        ...
                        transform="translate(-227.576 -76.46149)" fill="#ffb8b8"></path>
                    <path id="a6768b0e-63d0-4b31-8462-9b2e0b00f0fd-17" data-name="Path 101"
                        ...
                        transform="translate(-227.576 -76.46149)" fill="#007bff"></path>
                    <path id="bfd7963f-0cf8-4885-9d3a-2c00bccda2e3-18" data-name="Path 102"
            ...
            <div class="col-md-6">
                ...
                <form id="login-form" method="post" class="my-2">
                    ...
                    @if (isset($_GET['redirect_to']))
                        <input type="hidden" class="form-control" name="redirect_to" id="redirect_to"
                            value="{{ $_SERVER['HTTP_REFERER'] }}">
                    @endif

                    <button type="submit" class="sign-up btn btn-primary form-control mb-3">Login</button>
                ...
                <a href="{{ home_url('account-register') }}">
                    <button type="button" class="change-form btn btn-primary form-control my-3">Register</button>
                </a> --}}
