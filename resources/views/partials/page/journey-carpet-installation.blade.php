...
<script type="text/javascript" src="/assets/dist/js/journey-carpet-installation.js?v={{ time() }}"></script>
<script type="text/javascript" src="/assets/dist/js/input-authentication.js?v={{ time() }}"></script>

<div class="container journey journey-pressure-washing mt-5">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 pt-4 pb-2 services">
                                ...
                                <div class="input-group">
                                    <button type="button" class="btn check-button p-2 m-1 btn-outline-primary">Bedroom</button>
                                    <button type="button" class="btn check-button p-2 m-1 btn-outline-primary">Lounge room</button>
                                    <button type="button" class="btn check-button p-2 m-1 btn-outline-primary">Living room</button>
                                    <button type="button" class="btn check-button p-2 m-1 btn-outline-primary">Kitchen</button>
                                    <button type="button" class="btn check-button p-2 m-1 btn-outline-primary">Bathroom</button>
                                    <button type="button" class="btn check-button p-2 m-1 btn-outline-primary">Stairs</button>
                                    <button type="button" class="btn check-button p-2 m-1 btn-outline-primary">Laundry</button>
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
