...
class Controller {
    ...
    function __construct() {
        ...
        include_once(BASEPATH . 'ci_query_builder/system/database/DB.php');
        ...
        $db = "mysqli://" . DB_USER . ":" . DB_PASSWORD . "@" . DB_HOST . "/" . DB_NAME;
        $this->db = DB($db, true);
        // echo '<pre>';
        // print_r($this->db);
        // echo '</pre>';

        $this->input = new urlParam();
    }
}
